  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          className="min-w-[150px] h-[60px] text-black cursor-pointer font-semibold bg-white text-[19px] rounded-full px-[20px] py-[10px]"
        ...
        <div className="w-full h-[400px] overflow-y-auto flex flex-col gap-[20px] truncate">
          {userData.history?.map((his) => (
            <span className="text-gray-200 text-[18px] w-full h-[30px]">
              {his}
            </span>
          ))}
        </div>
      ...
      <button
        className="min-w-[150px] h-[60px]  mt-[30px] text-black cursor-pointer font-semibold absolute hidden lg:block top-[20px] right-[20px] bg-white rounded-full text-[19px]"
        onClick={handleLogOut}
      >
        Log Out
      </button>
      <button
        className="min-w-[150px] h-[60px]  mt-[30px] text-black cursor-pointer font-semibold absolute top-[100px] right-[20px] bg-white rounded-full text-[19px] px-[20px] py-[10px] hidden lg:block"
        onClick={() => navigate("/customize")}
      >
        Customize your Assistant
      </button>
